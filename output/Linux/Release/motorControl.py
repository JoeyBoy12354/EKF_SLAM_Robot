...
def getAngleDifference(LNoRot,RNoRot,angle):
    ...
    elif(abs(LNoRot/RNoRot) <=0.7 or abs(RNoRot/LNoRot) <=0.7 or abs(RNoRot - LNoRot) >= 0.011 ):
...
#     MCAL: time Left =  0.007913093196112065 s  0.002086906803887935 s
# MCAL: time Right =  0.007904328018223236 s  0.0020956719817767644 s
