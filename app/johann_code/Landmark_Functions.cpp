...
namespace Landmark_Functions{
    ...
    vector<Line> RANSAC(vector<CarPoint> laserdata){
        ...
        const int MAXTRIALS = 50000;//Max Times to run algorithm
        ...
        const double RANSAC_TOLERANCE = 20; //RANSAC: if point is within x distance of line its part of line [mm]
        const int RANSAC_CONSENSUS = 700; //RANSAC: at least X points in consensus required to determine if a line will be deemed valid 
